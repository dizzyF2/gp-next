...
import "./transferToCoachRegister.css"
...
function TransferToCoachRegister() {
    return (
        <div className="flex flex-col justify-center items-center gap-5 ml-10 md:ml-0">
            ...
            <button className="ml-36 bg-[#ff2625] uppercase rounded-lg p-2 text-sm text-white"><Link href={"../../pages/CoachRegister"}>register now</Link></button>
        </div>
    )
}
