                ...
                {coachReview.map((item)=>(
                    <div key={item.key} className="bg-slate-100 border border-slate-200 flex flex-col items-center p-6 space-y-2 rounded-lg dark:bg-gradient-to-t dark:from-[#ffffff0d] dark:to-[#ffffff0d]">
                        ...
                        <div className="flex justify-between w-full pt-5 pb-0">
                            <div></div>
                            <button className="bg-[#ff2625] uppercase rounded-lg p-2 text-sm text-white"><Link href={"../../pages/coachPage"}>more info</Link></button>
                        </div>
                    </div>
                ))}      
            </div>
            <div className="flex justify-center md:justify-end pt-2">
                    <button className="bg-[#ff2625] uppercase rounded-lg p-2 text-white"><Link href={"../../pages/Coaches"}>Show All</Link></button>
            </div>
        </div>
    )
}
