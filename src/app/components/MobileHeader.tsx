...
function MobileHeader() {
    ...
    return (
        <>
            ...
            <div className=" cursor-pointer hover:bg-slate-300 rounded-full p-2 duration-200" onClick={toggleShowMenu}><Menu size={20} className='text-black dark:text-white dark:hover:text-black'/></div>
            <div><ThemeSwitch/></div>
            </div>
