...
function UserMenu() {
    ...
    return (
        <div className='menu-container'>
            ...
            <div className={`dropdown-menu flex flex-col text-black gap-5 items-start absolute z-50 bg-blue-500 rounded-xl px-5 py-[10px] w-[200px] top-[75px] right-[65px] before:content-[''] before:absolute before:top-[-5px] before:right-5 before:h-5 before:w-5 before:bg-blue-500 before:rotate-[45deg] ${open? 'opacity-100 visible translate-y-0 ease-in duration-300' : 'opacity-0 hidden translate-y-[-20px] ease-out'}`}>
