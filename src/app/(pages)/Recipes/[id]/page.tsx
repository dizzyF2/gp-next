...
function RecipeInfo() {
    ...
    return (
        <div className='flex flex-col lg:gap-10 px-20 my-14'>
            <div className='py-10  gap-10 flex flex-col items-center justify-center'>
                ...
                <div className='flex flex-row gap-5'>
                    ...
                    <div className='flex flex-col justify-between'>
                        <span className=' text-black dark:text-white text-center border border-gray-500 py-1 px-2 rounded-full mb-2'>{recipe?.calories}</span>
            ...
            <div className='w-full flex flex-row gap-8 py-10 lg:py-20 px-4 md:px-10'>
                {/* LEFT SIDE */}
                <div className='w-full md:w-2/4 md:border-r border-slate-400 dark:border-slate-200 pr-1'>
                    <div className='flex flex-col items-center gap-5 '>
                        <p className='text-green-700 dark:text-green-500  bg-gray-300 dark:bg-gray-900 w-fit p-3 rounded-3xl text-2xl underline'>Ingredients</p>
                        {
                            recipe?.ingredientLines?.map((item:any, index:any)=>{
                                return(
                                    <p key={index} className='flex  text-black gap-2 dark:text-neutral-100 text-[12px] md:text-lg'>
                                        <Pin className='text-xl text-green-800'/>
                                        {item}
                                    </p>
                                )
                            })
